...
Esse é um bot de discord para servidores, e aqui estão algumas anotações sobre como utilizar o bot.
...
* Ter instalado Python na versão 3.5 ou superior (durante o desenvolvimento do bot, utilizamos o python na versão 3.5, então não podemos garantir que versões anteriores funcionem);
* Vá até o arquivo Token.py, e mude as informações de acordo com as orientações nele
